...
(function () {
    ...
    if (btn) {
        btn.addEventListener('click', (e) => {
            e.stopPropagation();
            // tu lógica de toggle aquí...
            // ...
            // quitar foco para que la barra espaciadora no vuelva a activarlo
            btn.blur();
        });
    }
    ...
    btn.addEventListener('click', () => {
        ...
        btn.textContent = bgMusic.volume == 0 ? '🔇' : '🔊';
